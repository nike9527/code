...
def check_keydown_evenrs(event, ai_setting, screen, ship, bullets):
	if event.key == pygame.K_RIGHT:
		...
		fire_buller(ai_setting,screen,ship,bullets)
...
def check_event(ai_setting, screen, ship, bullets, play_button, stats, aliens, sb):
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			sys.exit()
		elif event.type == pygame.KEYDOWN:
			check_keydown_evenrs(event, ai_setting, screen, ship, bullets)
		elif event.type == pygame.KEYUP:
			check_keyup_events(event, ai_setting, screen, ship, bullets)
		elif event.type == pygame.MOUSEBUTTONDOWN:
			mouse_x, mouse_y = pygame.mouse.get_pos()
			check_play_button(ai_setting, screen, stats, play_button, ship, aliens, bullets, mouse_x, mouse_y,sb)
...
def check_fleet_dedges(ai_setting,aliens):
...
def update_aliens(ai_setting,aliens,ship,screen,bullets,sb,stats):
	check_fleet_dedges(ai_setting,aliens)
	aliens.update()
	#检查外星人之间的碰撞
	...
	if pygame.sprite.spritecollideany(ship, aliens):
		ship_hit(ai_setting, screen, stats, sb, ship, aliens, bullets, sb)
...
def check_aliens_bottom(ai_setting,stats,screen,ship,aliens,bullets,sb):
	...
	for alien in aliens.sprites():
		if alien.rect.bottom >= screen_rect.bottom:
			ship_hit(ai_setting,stats,screen,ship,aliens,bullets,sb)
			break
def check_play_button(ai_setting, screen, stats, play_button, ship, aliens, bullets, mouse_x, mouse_y,sb):
